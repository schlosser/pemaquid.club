...
gulp.task('sass:lint', () => gulp.src('./src/sass/**/*.scss').pipe(plumber()).pipe(scsslint()));
...
gulp.task('images:optimized', () => gulp
  .src('src/img/**/*')
  .pipe(plumber())
  .pipe(
    imagemin({
...
gulp.task('resources', () => gulp
  .src('src/resources/*')
  .pipe(plumber())
  .pipe(gulp.dest('./dist/resources')));

gulp.task('fonts', () => gulp.src('src/font/*').pipe(plumber()).pipe(gulp.dest('./dist/font')));
